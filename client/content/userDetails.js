...
export const userDetails = {
    ...
    description: (
        <Box>
            ...
            <Typography paragraph>
                After I graduated from Bloomtech, I worked as a Code Reviewer,
                where I provided actionable feedback to student developers on
                their sprint challenge submissions. While I enjoyed my time as a
                Code Reviewer, I left the position to focus on finding a
                full-time Software Engineering role whose products and projects
